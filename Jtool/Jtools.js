var Jtool = /** @class */ (function () {
    ...
    /**
       ...
       默认为0
       */
    Jtool.unixToStr = function (a, b, c) {
        a = parseInt(a);
        a = isNaN(a) ? 0 : a;
        b = b === void 0 ? "nl" : b;
        c = c === void 0 ? 0 : c;
    ...
    /**
       ...
       */
    Jtool.dateToUnix = function (a, b) {
        if (a === void 0 || a == 0 || isNaN(Date.parse(a))) {
            if (!b) {
                a = this.unixToStr(0);
            }
            else
                a = this.unixToStr(0, "ns");
        }
        switch (b) {
            case "e":
                a += " 23:59:59";
        ...
        if (arr.length == 3) {
            var dd = new Date();
            var h = dd.getHours(), m = dd.getMinutes(), s = dd.getSeconds();
            new_str += '-' + h + "-" + m + "-" + s;
            var arr = new_str.split("-");
        }
    ...
    */
     ...
     * @param value     //新值
     */
    Jtool.setData = function (source, value) {
        if (!source || !value)
            return;
        for (var x in value) {
            var d = value[x];
    ...
    Jtool.cookie = function (name, value, options) {
